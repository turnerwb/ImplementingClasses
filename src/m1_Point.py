...
class Point(object):
    ...
    def move_to(self, x, y):
        ...
        self.y = y
        self.moves += 1
        self.distancetraveled += math.sqrt(math.fabs(self.x - tempx) ** 2 + math.fabs(self.y - tempy) ** 2)
    ...
    def move_by(self, dx, dy):
        ...
        self.y = self.y + dy
        self.moves += 1
        self.distancetraveled += math.sqrt(math.fabs(dx) ** 2 + math.fabs(dy) ** 2)
    ...
    def get_distance_from(self, point):
        import math
        distance = math.sqrt(math.fabs(self.x - point.x)**2 + math.fabs(self.y - point.y)**2)
        return distance

    def get_distance_from_start(self):
        import math
        distance = math.sqrt(math.fabs(self.x - self.xstart) ** 2 + math.fabs(self.y - self.ystart) ** 2)
        return distance
    ...
    def closer_to(self, p1, p2):
        import math
        distance1 = math.sqrt(math.fabs(self.x - p1.x) ** 2 + math.fabs(self.y - p1.y) ** 2)
        distance2 = math.sqrt(math.fabs(self.x - p2.x)**2 + math.fabs(self.y - p2.y)**2)
